...
export type HttpStatusCode = 
  ...
  | 500  // Internal serverver Error
  | 502  // Bad Gateway
  | 503  // servervice Unavailable
  | 504; // Gateway Timeout

// errorcode映射toHTTPStatus码
