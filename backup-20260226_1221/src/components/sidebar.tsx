...
const navGroups = [
  {
    ...
    items: [
      ...
      { title: "系统监控",  href: "/system-monitoring", icon: Server, badge: "new" },
      { title: "外部API监控", href: "/external-apis", icon: Globe, badge: "new" },
    ],
  },
  {
    label: "工具",
    items: [
      { title: "工具管理",     href: "/tools",             icon: Wrench,      badge: "new" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "任务管理",   href: "/tasks",        icon: Calendar,  badge: "new" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "知识管理系统", href: "/",  icon: BookOpen, badge: "new" },
    ],
  },
];
